...
// #define destination_ip 10.2.239.76
 #define destination_ip 192.168.122.1
...
void get_eth_index()
{
	...
	strncpy(ifreq_i.ifr_name,"wlp0s26f7u2",IFNAMSIZ-1);
...
void get_mac()
{
	...
	strncpy(ifreq_c.ifr_name,"wlp0s26f7u2",IFNAMSIZ-1);
...
void get_ip()
{
	...
	strncpy(ifreq_ip.ifr_name,"wlp0s26f7u2",IFNAMSIZ-1);
